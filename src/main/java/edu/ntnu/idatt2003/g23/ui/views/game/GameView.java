...
public final class GameView implements GameViewInterface {
  ...
  public GameView(GameController gameController, Runnable onBack, Runnable onSettings,
  ...
  public GameView(GameController gameController, Runnable onBack, Runnable onSettings,
    ...
    HBox topBar =
        new HBox(10, backBtn, appTitle, tl, statusPill, cashPill, portPill, nwPill, settingsBtn);
    ...
    pane.setOnMouseMoved(e -> {
      ...
      if (hit != null) {
        ...
        if (!weekBuys.isEmpty()) {
          ...
          Label priceLbl = new Label((weekBuys.size() > 1 ? "Avg price: " : "Price: ") +
        ...
        if (!weekSells.isEmpty()) {
          ...
          Label quantityLbl =
              new Label("Quantity: " + totalQty.stripTrailingZeros().toPlainString());
          quantityLbl.getStyleClass().add("chart-tooltip-row");
          Label priceLbl = new Label((weekSells.size() > 1 ? "Avg price: " : "Price: ") +
              CurrencyFormatter.format(avgPrice));
          priceLbl.getStyleClass().add("chart-tooltip-row");
