...
public final class AppConfig {
    ...
    public static final Duration SPLASH_FADE_DURATION = Duration.seconds(0.8);
    public static final Duration SPLASH_DELAY = Duration.seconds(110.0 / 60.0); // 110 BPM = 110/60 beats per second
