...
public class CsvRow {
  ...
  public void setPrices(String v) {
    prices.set(v == null ? "" : v);
  }

  public SimpleStringProperty pricesProperty() {
    return prices;
  }
  ...
  public String getErrorColumn() {
    return errorColumn.get();
  }

  public void setErrorColumn(String v) {
    errorColumn.set(v == null ? "" : v);
  }

  public SimpleStringProperty errorColumnProperty() {
    return errorColumn;
  }
}
