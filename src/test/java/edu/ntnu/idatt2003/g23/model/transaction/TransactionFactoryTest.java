...
class TransactionFactoryTest {
  ...
  void testCreateTransactionType() {
    ...
    Transaction purchase =
        TransactionFactory.createTransaction(TransactionFactory.TransactionType.PURCHASE, share, 1);
    assertTrue(purchase instanceof Purchase);

    Transaction sale =
        TransactionFactory.createTransaction(TransactionFactory.TransactionType.SALE, share, 1);
