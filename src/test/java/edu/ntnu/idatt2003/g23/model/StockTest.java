...
class StockTest {
  ...
  class ConstructorValidationTests {
    ...
    void testConstructorThrowsOnEmptyPrices() {
      assertThrows(IllegalArgumentException.class,
          () -> new Stock("AAPL", "Apple Inc.", new ArrayList<>()));
    }
  }
  ...
  void testGetHistoricalPrices() {
    List<BigDecimal> prices =
        new ArrayList<>(List.of(new BigDecimal("100"), new BigDecimal("110")));
    Stock stock = new Stock("AAPL", "Apple Inc.", prices);
  ...
  class PercentageChangeTests {
    ...
    void testSinglePrice() {
      Stock stock =
          new Stock("AAPL", "Apple Inc.", new ArrayList<>(List.of(new BigDecimal("100"))));
  ...
  class AllTimeHighTests {
    ...
    void testAllTimeHigh() {
      Stock stock = new Stock("AAPL", "Apple Inc.",
          new ArrayList<>(
              List.of(new BigDecimal("80"), new BigDecimal("200"), new BigDecimal("150"))));
  ...
  class PercentageChangeOverWeeksTests {
    ...
    void testNegativeWeeksUsesAllTime() {
      Stock stock = new Stock("AAPL", "Apple Inc.",
          new ArrayList<>(
              List.of(new BigDecimal("100"), new BigDecimal("120"), new BigDecimal("150"))));
