...
class StockCsvLoaderTest {
    ...
    class ParseWithErrorsTests {
        ...
        void testOneColumnRow() {
            ...
            assertTrue(result.getRows().get(0).getErrorMessage().contains("missing the company name and price"));
        }
        ...
        void testEmptySymbol() {
            CsvParseResult result = StockCsvLoader.parseWithErrors(new StringReader(",Apple Inc.,150.00"));
            assertTrue(result.getRows().get(0).hasError());
        ...
        void testLowercaseSymbol() {
            CsvParseResult result = StockCsvLoader.parseWithErrors(new StringReader("aapl,Apple Inc.,150.00"));
        ...
        void testDigitInSymbol() {
            CsvParseResult result = StockCsvLoader.parseWithErrors(new StringReader("A1PL,Apple Inc.,150.00"));
            CsvRow row = result.getRows().get(0);
            assertTrue(row.hasError());
        ...
        void testSpecialCharInSymbol() {
            CsvParseResult result = StockCsvLoader.parseWithErrors(new StringReader("A@PL,Apple Inc.,150.00"));
            CsvRow row = result.getRows().get(0);
            assertTrue(row.hasError());
        ...
        void testZeroPrice() {
            CsvParseResult result = StockCsvLoader.parseWithErrors(new StringReader("AAPL,Apple Inc.,0.00"));
            CsvRow row = result.getRows().get(0);
            assertTrue(row.hasError());
        ...
        void testNegativePrice() {
            CsvParseResult result = StockCsvLoader.parseWithErrors(new StringReader("AAPL,Apple Inc.,-5.00"));
            CsvRow row = result.getRows().get(0);
            assertTrue(row.hasError());
            assertTrue(row.getErrorMessage().contains("greater than zero"));
        }
        ...
        void testNonNumericPrice() {
            CsvParseResult result = StockCsvLoader.parseWithErrors(new StringReader("AAPL,Apple Inc.,abc"));
            CsvRow row = result.getRows().get(0);
            assertTrue(row.hasError());
        ...
        void testEmptySegmentsBetweenSemicolons() {
            CsvParseResult result = StockCsvLoader.parseWithErrors(new StringReader("AAPL,Apple Inc.,150.00;;200.00"));
            CsvRow row = result.getRows().get(0);
